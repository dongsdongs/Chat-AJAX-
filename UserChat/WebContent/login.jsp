...
<body>
	...
	<div class="container">
		<form method="post" action="./UserLoginSevlet">
			<table class="table table-bordered table-hobver" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
				...
				<tbody>
					...
					<tr>
						<td style="text-align: left;" colspan="2"><input class="btn btn-primary pull-right" type="submit" value="login"></td>
